...
public class AdminsAssistLibrarianController implements Initializable {

    @FXML
    private Label adminAssistLibrarianEmail;
    ...
    public void data(String data) {
        user = data;
        adminAssistLibrarianEmail.setText(user);
    }
    ...
    public void Home(){
        try{
            ...
            adminViewController.data(adminAssistLibrarianEmail.getText());
