...
public class AdminsBookController implements Initializable {
    ...
    void AddClick(ActionEvent event) throws Exception{
        /*
        Parent root = FXMLLoader.load(getClass().getResource("admins_add_new_book_view.fxml"));
    ...
    public void AddNewBook(){
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("admins_add_new_book_view.fxml"));
            Parent root = loader.load();
            AdminsAddNewBookController adminsAddNewBookController = loader.getController();
            adminsAddNewBookController.data(adminBookEmail.getText());
    ...
    public void Home(){
        try{
            ...
            adminViewController.data(adminBookEmail.getText());
