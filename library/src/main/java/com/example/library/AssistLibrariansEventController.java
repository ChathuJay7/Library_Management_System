...
public class AssistLibrariansEventController implements Initializable {

    @FXML
    private Button addBtn;

    @FXML
    private Label assistLibrarianEventEmail;
    ...
    public void data(String data) {
        user = data;
        assistLibrarianEventEmail.setText(user);
    }
    ...
    public void Home(){
        try{
            ...
            assistLibrariansViewController.data(assistLibrarianEventEmail.getText());
