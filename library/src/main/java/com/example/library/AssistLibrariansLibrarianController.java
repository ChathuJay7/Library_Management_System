...
public class AssistLibrariansLibrarianController implements Initializable {

    @FXML
    private Label assistLibrarianLibrarianEmail;
    ...
    public void data(String data) {
        user = data;
        assistLibrarianLibrarianEmail.setText(user);
    }
    ...
    public void Home(){
        try{
            ...
            assistLibrariansViewController.data(assistLibrarianLibrarianEmail.getText());
