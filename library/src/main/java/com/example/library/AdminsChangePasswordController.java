...
public class AdminsChangePasswordController {

    @FXML
    private Label adminsChangePasswordEmail;
    ...
    public void initData(CurrentUser currentUser) {
        ...
        adminsChangePasswordEmail.setText(user);
    }
    ...
    public void ChangePasswordAdmin() throws NoSuchAlgorithmException {
        ...
        email = adminsChangePasswordEmail.getText();
        ...
        String query = "UPDATE admin SET password = '" + hashedpassword + "' where email = '" + email + "'";
