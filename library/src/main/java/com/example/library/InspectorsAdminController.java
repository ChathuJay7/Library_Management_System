...
public class InspectorsAdminController implements Initializable {

    @FXML
    private Label inspectorAdminEmail;
    ...
    public void data(String data) {
        user = data;
        inspectorAdminEmail.setText(user);
    }
    ...
    public void Home(){
        try{
            ...
            inspectorViewController.data(inspectorAdminEmail.getText());
