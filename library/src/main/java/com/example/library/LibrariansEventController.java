...
public class LibrariansEventController implements Initializable {
    ...
    @FXML
    private Label librarianEventEmail;
    ...
    public void initData(CurrentUser currentUser) {
        ...
        librarianEventEmail.setText(user);
    }
    ...
    public void Home(){
        try{
            ...
            librarianViewController.data(librarianEventEmail.getText());
