...
public class AssistLibrariansChangePasswordController {

    @FXML
    private Label assistLibrariansChangePasswordEmail;
    ...
    public void initData(CurrentUser currentUser) {
        ...
        assistLibrariansChangePasswordEmail.setText(user);
    }
    ...
    public void ChangePasswordAssistLibrarian() throws NoSuchAlgorithmException {
        ...
        email = assistLibrariansChangePasswordEmail.getText();
