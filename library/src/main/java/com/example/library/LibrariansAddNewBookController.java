...
public class LibrariansAddNewBookController {
    ...
    @FXML
    private Label librarianAddNewBookEmail;
    ...
    public void initData(CurrentUser currentUser) {
        ...
        librarianAddNewBookEmail.setText(user);
    }
    ...
    public void BookDetails(){
        try{
            ...
            librariansBookController.data(librarianAddNewBookEmail.getText());
