...
public class InspectorsChangePasswordInsideProfileController {
    ...
    @FXML
    void UpdateClick(ActionEvent event) throws NoSuchAlgorithmException {
        UpdateProfilePage();
    }
    ...
    public void UpdateProfilePage(){
        try{
            ...
            inspectorsUpdateDetailsController.data(changePasswordEmail.getText());
